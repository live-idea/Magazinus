...
class OrderItemsControllerTest < ActionController::TestCase
  ...
  test "should show order_item" do
    get :show, :id => order_items(:one).to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, :id => order_items(:one).to_param
    assert_response :success
  end

  test "should update order_item" do
    put :update, :id => order_items(:one).to_param, :order_item => { }
    assert_redirected_to order_item_path(assigns(:order_item))
  end

  test "should destroy order_item" do
    assert_difference('OrderItem.count', -1) do
      delete :destroy, :id => order_items(:one).to_param
    end
